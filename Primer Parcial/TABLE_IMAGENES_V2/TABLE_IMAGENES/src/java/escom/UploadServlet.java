...
@WebServlet("/TABLE_IMAGENES/UploadServlet?")
public class UploadServlet extends HttpServlet {

    
    private boolean isMultipart;
    private String filePath;
    private int maxFileSize = 50 * 1024 * 1024;//Con dos es MB
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String parametros = "";
         ...
         for (int j = 0; j < filas_i; j++) 
                ...
                parametros += "reference_"+j+"_"+l+"="+request.getParameter("reference_"+j+"_"+l+"")+"&";
            }
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (!fi.isFormField()) {
                    ...
                    session.setAttribute(("nombrevideo"+x), fileName);
            ...
            session.setAttribute("imagenes", Integer.toString(x));
            
       
             response.sendRedirect("Servlet0");
