...
public class Servlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            for (int i = 0; i < numero_i ; i++){
                    ...
                    out.println("<a href='ServletContenido?reference="+request.getParameter("reference_"+i) +"&"+"contenido="+request.getParameter("contenido_"+i)+ "' target='titulo' ><embed src='"+nombrevideo+"' width='100' height='100'></a></br>");
